    ...
    $.the7Slider = function (el, userSettings) {
        ...
        methods = {
            ...
            getThumbsOptions: function () {
                ...
                let thumbsDirection = methods.getDirection('desktop');
                ...
                Object.keys(breakpoints).forEach(breakpointName => {
                    let breakPointVal = breakpoints[breakpointName].value;
                    swiperOptions.breakpoints[breakPointVal] = {};
                    let thumbsDirection = methods.getDirection(breakpointName);
                    if (thumbsDirection) {
                        swiperOptions.breakpoints[breakPointVal].direction = thumbsDirection;
                    }
